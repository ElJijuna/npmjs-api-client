...
| `topPackages(n?, signal?)`               | `GET /-/v1/search?text=keywords:javascript&size={n}`                                     | ✅     |
| `topByPopularity(n?, signal?)`           | `GET /-/v1/search?text=keywords:javascript&size={n}&popularity=1&quality=0&maintenance=0` | ✅     |
| `topByQuality(n?, signal?)`              | `GET /-/v1/search?text=keywords:javascript&size={n}&quality=1&popularity=0&maintenance=0` | ✅     |
| `topByMaintenance(n?, signal?)`          | `GET /-/v1/search?text=keywords:javascript&size={n}&maintenance=1&quality=0&popularity=0` | ✅     |
